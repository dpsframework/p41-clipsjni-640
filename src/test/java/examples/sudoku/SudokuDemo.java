  ...
  {  
   ...
   SudokuDemo() 
     {    
      ...
      try
        {
         sudokuResources = ResourceBundle.getBundle("examples.sudoku.resources.SudokuResources",Locale.getDefault());
        }
      ...
      try
        {
         clips.loadFromResource("/examples/sudoku/resources/sudoku.clp");
         clips.loadFromResource("/examples/sudoku/resources/solve.clp");
        }
      catch (Exception e)
        {
         e.printStackTrace();
