  ...
  {  
   ...
   AutoDemo()
     {  
      try
        {
         autoResources = ResourceBundle.getBundle("examples.auto.resources.AutoResources",Locale.getDefault());
        }
      ...
      try
        {
         clips.loadFromResource("/examples/auto/resources/auto.clp");

         try 
           {
            clips.loadFromResource("/examples/auto/resources/auto_" + 
         ...
         catch (FileNotFoundException fnfe)
           {
            if (Locale.getDefault().getLanguage().equals("en"))
              ...
              { clips.loadFromResource("/examples/auto/resources/auto_en.clp"); }
           }
