...
class RouterDemo implements ActionListener {
    class CLIPSProgramRunner extends SwingWorker<Integer, Integer> {
        ...
        static final String resourcePath = "/examples/router/resources/";

        public CLIPSProgramRunner(Environment theEnv, String theLoadFiles[], JButton theRestartButton) {
            this.workEnv = theEnv;
    ...
    RouterDemo() {
        try {
            routerResources = ResourceBundle.getBundle("examples.router.resources.RouterResources",
                    Locale.getDefault());
        ...
        routerDemoFrame.getContentPane().setLayout(new BoxLayout(routerDemoFrame.getContentPane(), BoxLayout.Y_AXIS));
        ...
        layout.setHorizontalGroup(
                layout.createSequentialGroup().addComponent(restartAutoButton).addComponent(restartAnimalButton));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                .addComponent(restartAutoButton).addComponent(restartAnimalButton));
    ...
    public void runAuto() {
        String autoFileNames[] = { "auto.clp", "auto_" + Locale.getDefault().getLanguage() + ".clp" };
        new CLIPSProgramRunner(autoEnv, autoFileNames, restartAutoButton).execute();
    }

    public void runAnimal() {
        String animalFileNames[] = { "bcengine.clp", "animal.clp",
