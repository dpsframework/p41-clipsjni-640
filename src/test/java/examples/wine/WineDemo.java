  ...
  {  
   ...
   WineDemo()
     {  
      try
        {
         wineResources = ResourceBundle.getBundle("examples.wine.resources.WineResources",Locale.getDefault());
        }
      ...
      try
        {
         clips.loadFromResource("/examples/wine/resources/wine.clp");
        }
      catch (Exception e)
        {
         e.printStackTrace();
