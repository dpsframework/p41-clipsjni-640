...
class AnimalDemo implements ActionListener {
    ...
    AnimalDemo() {
        try {
            animalResources = ResourceBundle.getBundle("examples.animal.resources.AnimalResources",
                    Locale.getDefault());
        ...
        try {
            clips.loadFromResource("/examples/animal/resources/bcengine.clp");
            clips.loadFromResource("/examples/animal/resources/animal.clp");

            try {
                clips.loadFromResource("/examples/animal/resources/animal_"
                        + Locale.getDefault().getLanguage() + ".clp");
            } catch (FileNotFoundException fnfe) {
                if (Locale.getDefault().getLanguage().equals("en")) {
                    throw fnfe;
                } else {
                    clips.loadFromResource("/examples/animal/resources/animal_en.clp");
                }
            }
